    ...
    function tokenURI(uint256 tokenId) public view returns (string memory) {
        ...
        return string.concat(
            ...
            Base64.encode(abi.encodePacked(
                ...
                '"image":"', image, '",',
                '"description":"Avatizer is a unique generative art project with a limited supply - only 999 NFT tokens! Each day you get a new PFP image generated by the smart contract that runs completely autonomously on the Ethereum blockchain. No servers, no external scripts or links, no pre-made images! Pure art.",',
                '"attributes":[',
